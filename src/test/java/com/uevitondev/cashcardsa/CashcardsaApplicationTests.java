...
import com.uevitondev.cashcardsa.cashcard.CashCard;
...
class CashcardsaApplicationTests {
    ...
    void shouldReturnAllCashCardsWhenListIsRequested() {
        ...
        assertThat(amounts).containsExactlyInAnyOrder(120.00, 1.00, 150.00);
    }
    ...
    void shouldReturnASortedPageOfCashCardsWithNoParametersAndUseDefaultValues() {
        ...
        JSONArray amounts = documentContext.read("$..amount");
        assertThat(amounts).containsExactly(1.00, 120.00, 150.00);
    }
    ...
    void shouldNotUpdateACashCardThatIsOwnedBySomeoneElse() {
        ...
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/1", HttpMethod.PUT, request, Void.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
